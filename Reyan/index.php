...
<body>
  ...
  <img src="shop1.jpg" width="100%" height="400">
  <div class="container">
  <script src="BADAT.js"></script>
    <?php
    if (isset($_GET["msg"])) {
      $msg = $_GET["msg"];
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="branch.html" tabindex="-1" aria-disabled="true">Branch</a>
        </li>
      </ul>
    </div>
  </button>
...
<script>
  $(document).ready( function () {
    $('#table').DataTable();
     ...
     <div id="container">
    <a class="nav-link active" href="login.html">&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;LOGOUT</a> 
</div>
</body>
